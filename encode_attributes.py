...
from maxValues import MAX_DAMAGE, MAX_CARDS_IN_ONE_PLAY_ZONE, MAX_RESOURCES, CARD_FEATURE_DIM, \
    MAX_ACTIONS, MAX_ACTION_ARGS, ACTION_TYPES, ATTACHMENT_CARD_FEATURE_DIM, MAX_ATTACHMENTS_PER_CARD, TARGET_TYPES, \
    MAX_HAND_SIZE, NUM_PLANETS, MAX_DISCARD_SIZE, UNIQUE_CHOICES, NUM_SPECIAL_CHOICES, PHASES, NUM_PHASES, MODES, \
    NUM_MODES, CARD_TYPES, NUM_CARD_TYPES, MAX_COMMAND, MAX_ATTACK, MAX_HEALTH, MAX_ONE_ICON, NUM_ROUNDS, MAX_PREVIOUS_ACTIONS, \
