...
if response.status_code == 200:
    ...
    model_1 = keras.models.load_model(file_name_model_1, safe_mode=False)
    model_2 = keras.models.load_model(file_name_model_2, safe_mode=False)
                    ...
                    if action_required:
                        if num_times_a_timeout_occurred > max_timeouts:
                            ...
                            if game.active_player == game.player_one.name:
                                ...
                                model = model_2
                            outputs = model_make_choice(model, game, training=training, choose_random=False, filter_moves=filter_moves)
