...
from maxValues import OUTPUT_DIM, MAX_HAND_SIZE, MAX_CARDS_IN_ONE_PLAY_ZONE, CARD_FEATURE_DIM, MAX_ACTIONS, \
    MAX_ACTION_ARGS, NUM_SCALARS, NUM_ACTION_TYPES, NUM_PLANETS, PLANET_VOCAB_SIZE, \
    MAX_DISCARD_SIZE, NUM_HEADS, FF_DIM, DROPOUT_RATE, MAX_SEARCHED_CARDS, MAX_PREVIOUS_ACTIONS, HEAD_SIZE
